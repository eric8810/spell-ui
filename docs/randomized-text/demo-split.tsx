  ...
  return (
    <div className="flex flex-col justify-start items-center min-h-[200px] w-[500px] gap-4">
        <div className="flex flex-col items-start gap-1 justif-start">
          ...
          <RandomizedText split="chars" className="text-base tracking-tight font-medium">Lorem ipsum dolor sit amet consectetur adipisicing elit. Perferendis debitis ipsam saepe incidunt laboriosam eaque quasi commodi beatae excepturi quos!</RandomizedText>
        </div>
        <div className="flex flex-col items-start gap-1 justif-start">
